/* GOV UK resource taken from

https://www.findapprenticeship.service.gov.uk/bundles/nas/locationsearch?v=IkArt4ILYgHn0y5EfPCxG_jf65Ph7yBUtm7cYoErwmQ1

*/

var postcodeselectorid;
...
function(n) {
    if (n.fn.locationMatch = function(t) {
        function c(t, f) {
            return jQuery.support.cors = !0, n.ajax({
                url: i.url,
                type: "GET",
                data: {
                    term: f,
                ...
                success: function(f) {
                    r = [];
                    u = f;
                    f != null && n.each(f, function(n, t) {
                        n < i.maxListSize && r.push(t.Name)
                    });
                    t(r)
                },
                error: function() {}
        ...
        function l(t) {
            var i, f;
            return u != null && (i = n.inArray(t, r), i != -1 && (f = u[i], f != null)) ? f : s(t)
        }
        var e = n(this),
            i = n.extend({
                delay: 200,
            ...
            r = [],
            u, f = n(postcodeselectorid).val(),
            s = function(n) {
                this.Name = n;
                this.Easting = null;
                this.Northing = null
            }, o = function() {
                i.easting != null && n(i.easting).val(null);
                i.northing != null && n(i.northing).val(null)
            }, h = function(t) {
                var i = [n.ui.keyCode.UP, n.ui.keyCode.DOWN, n.ui.keyCode.ESCAPE, n.ui.keyCode.ENTER, n.ui.keyCode.TAB, n.ui.keyCode.PAGE_UP, n.ui.keyCode.PAGE_DOWN, n.ui.keyCode.HOME, n.ui.keyCode.END];
                return n.inArray(t, i) !== -1
            };
        e.keyup(function(t) {
            f = n(postcodeselectorid).val();
            h(t.keyCode) || o()
        });
        e.autocomplete({
            delay: i.delay,
            ...
            messages: {
                noResults: function() {
                    return "No places found with " + f + " in their name"
                },
                results: function(n) {
                    return "We've found " + n + (n > 1 ? " places" : " place") + " with " + f + " in the name. Use up and down arrow keys to navigate"
                }
            },
            select: function(t, r) {
                n("#locationSuggestions").addClass("hidden");
                n("#locationSuggestions").removeAttr("open");
                n("#locationSuggestions").removeClass("open");
                this.value = r.item.value;
                var u = l(r.item.value);
                i.easting != null && n(i.easting).val(u.Easting);
                i.northing != null && n(i.northing).val(u.Northing)
            },
            change: function(n, t) {
                t.item == null && o()
            }
        })
    }, n("#locationSuggestions").length) {
        var t = n("#location-suggestions li").length;
        n("#locSuggestionsAria").text("There are " + t + " locations with similar names, tab down to the suggestions, or collapse this panel")
    }
    n(document).on("suggestedLocationsUpdated", function(t, i) {
        n("#locationSuggestions").removeClass("hidden");
        n("#locationSuggestions").attr("open", !0);
        n("#locationSuggestions").addClass("open");
        n("#location-suggestions").empty();
        n(postcodeselectorid).val(i.location);
        _.each(i.locations, function(t) {
            n("#location-suggestions").append(n("<li>").append(n("<a>").attr("href", t.Href).append(t.Text)))
        })
    })
}(jQuery);
...
$(document).ready(function() {
    if ( $('#id_postcodeselectorid').length ) {
        postcodeselectorid = $('#id_postcodeselectorid').val();
    } else {
        postcodeselectorid = '#search_location';
    }
